...
export const FIXTURE_MARKDOWN = [
  ...
  '| Surface | State | Notes |',
  '|:--------|:-----:|------:|',
  '| Commit graph | done | virtualised |',
  '| Working tree | done | stage, unstage, `commit` |',
  '| Blame | ~~shipped~~ not yet | engine has it |',
  '',
  '- [x] Read a diff',
  '- [x] Stage a file',
  '- [ ] Blame a line',
  '',
  '- Nested things',
  '  - resolve against MAX_BUFFER_SIZE',
  '  - and a wrapped item that',
  '    keeps going on the next line',
  '',
  '![the app](docs/shot.png)',
  '',
  'Report anything odd at <https://github.com/capad-xyz/grove>.',
  '',
  '---',
  '',
